...
//keep
public class SleeveDetectionRed extends OpenCvPipeline implements PropDetection{
    ...
    private double minC = 70000; //Min amount of green allowed
    ...
    private static Point TOPMID = new Point(835,450);
    ...
    public SleeveDetectionRed(Telemetry telemetry) {
    ...
    public Scalar lower = new Scalar(123, 12, 56);
    public Scalar upper = new Scalar(200, 83, 110);
    ...
    public Mat processFrame(Mat input) {
        ...
        if (leftColors.val[0] < midColors.val[0] && midColors.val[0] > minC) {
            position = "left";
        }
        else if(leftColors.val[0] > midColors.val[0] && leftColors.val[0] > minC) {
            position = "mid";
        }
        else{
            position = "right";
