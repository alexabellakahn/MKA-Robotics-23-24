...
@TeleOp(name="OneServoBranch", group="Linear Opmode")
public class OneServoBranch extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.a) grip.setPosition(.4);
            else if (gamepad1.b) grip.setPosition(.15);
            ...
            telemetry.addData("position", (float)grip.getPosition()); 
            telemetry.update();
        }
    }
}
